...
"set viminfo+=n~/.cache/nvim/nviminfo
"set shada+="$HOME/.cache/nvim/nvim.shada"
set showmode
set colorcolumn=110
set splitbelow
set splitright
...
Plug 'git://github.com/marijnh/tern_for_vim'        "javascript/meteor things
"Plug 'https://github.com/xolox/vim-easytags.git'
"Plug 'https://github.com/bbchung/clighter'
Plug 'https://github.com/Rykka/riv.vim.git' "rst note taking
Plug 'https://github.com/mattn/calendar-vim.git'
"Plug 'https://github.com/guyzmo/notmuch-abook.git'
...
"Plug 'https://github.com/klen/unite-radio.vim.git'
...
"Plug 'https://github.com/jeaye/color_coded.git', { 'do': 'cmake . && make' }
